...
public class MultiblockInfoEmiRecipe extends ModularEmiRecipe<WidgetGroup> {
    ...
    public void addWidgets(WidgetHolder widgets) {
        ...
        slotWidget = new SlotWidget(EmiStack.of(definition.getItem().asItem()),
                ConfigHolder.INSTANCE.client.patternPreviewWidgetConfigs.PatternPreviewWidgetSlotX,
                ConfigHolder.INSTANCE.client.patternPreviewWidgetConfigs.PatternPreviewWidgetSlotY)
                .recipeContext(this)
                .drawBack(false);
